...
export default function Youtube() {
	...
	const playlist = "UUDy8zqsb1-0qFZqG689fZ3Q";
	const num = 9;
		...
		<>
			<main className="content youtube" ref={main}>
				<figure className="subvisual">
					...
					<div className="con">
						<h1>
							Explore what's Priceless <br /> around the globe.
						</h1>
					</div>
				</figure>
				<div className="inner">
					<section>
						...
						<div className="preview">
							<div className="con" ref={con}>
								<h2>
									MASTERCARD <br /> <span>INNOVATION</span>
								</h2>
								<p>
									Lorem ipsum dolor sit amet consectetur
									adipisicing elit. Quam, voluptates et
									mollitia eum dolore consequatur vitae
									reprehenderit laudantium sint, fuga
									voluptatem nobis natus sit enim? Qui
									doloribus ex consequatur quae, eum repellat?
									Quis et cum nemo totam praesentium eum
									neque, quidem numquam culpa excepturi vitae.
									Nihil maxime quod molestiae perferendis?
								</p>
							</div>
							<div className="video">
								<iframe
